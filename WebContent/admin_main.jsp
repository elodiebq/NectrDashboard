                                    ...
                                    <div class="panel panel-white no-radius">
                                        ...
                                        <div class="panel-body no-padding">
                                            <div class="padding-10">
                                                ...
                                                <h4 class="no-margin inline-block padding-5">Mario's East <span class="block text-small text-left">UI Designer</span></h4>
                                                            ...
                                                            <table class="table no-margin">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><span class="text-small block text-light">Visual Designer</span><span>Sushi Fuku</span></td>
                                                                        <td class="center">
                                                                        <div class="cl-effect-13">
                                                                            <a href>
                                                                                view more
