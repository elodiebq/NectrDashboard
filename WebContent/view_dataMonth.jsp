                    ...
                    <div class="container-fluid container-fullw padding-bottom-10">
                        <div class="row">
                            ...
                            <h5 class="over-title">
                                ...
                                <span class="text-bold">View from ${currTime} to ${timeTo}</span>
                            </h5>
                            <div class="col-md-8">
                                <div class="panel panel-white no-radius" id="visits">
                                    <div class="panel-heading border-light">
                                        ...
                                        <form action="view_data_month.do">
                                            <div class="col-sm-10 col-lg-7 input-group" style="display:inline;margin-left:20px">

                                                <span>From:&nbsp</span><input type="month" style="width:150px"   name="chooseMonthFrom" id="form-field-mask-1"
                                                    >
                                                    <span>To:&nbsp</span><input type="month" style="width:150px" name="chooseMonthTo" id="form-field-mask-1"
                                                    > <span
                                                    >
                                    ...
                                    <div collapse="visits" class="panel-wrapper">
                                        <div class="panel-body">
                                            <div class="height-350">
                                                ...
                                                <canvas id="month" class="full-width" width="1176"
