		...
		<div class="sidebar app-aside" id="sidebar">
			<div class="sidebar-container perfect-scrollbar">
				<nav>
					...
					<ul class="folders">
						<li><a href="campaign_history.jsp">
								<div class="item-content">
									<div class="item-media">
										<span class="fa-stack"> <i
											class="fa fa-square fa-stack-2x"></i> <i
					...
					<div class="viewData" style="margin-up: -100px;">
						...
						<div class="col-md-4">
							<table>
								...
								<tr>
									<h2>
										Walk in &nbsp&nbsp&nbsp&nbsp<span class="label label-success">${walkInByDay}</span>
									</h2>
								</tr>
								<tr>
									<br />
								...
								<tr>
									<h2>
										Walk by &nbsp&nbsp&nbsp<span class="label label-warning">${walkByDay}</span>
									</h2>
								</tr>
								<tr>
									<br />
