                                    ...
                                    <div class="panel-heading border-light">
                                        ...
                                        <form action="view_data_year.do">
                                            <div class="col-sm-10 col-lg-7 input-group" style="display:inline;margin-left:20px">
                                                ...
                                                <span>From:&nbsp</span><input type="year" style="width:150px"   name="chooseYearFrom" id="form-field-mask-1"
                                                    >
                                                    <span>To:&nbsp</span><input type="year" style="width:150px" name="chooseYearTo" id="form-field-mask-1"
                                                    > <span
                                                    >
                                    ...
                                    <div collapse="visits" class="panel-wrapper">
                                        <div class="panel-body">
                                            <div class="height-350">
                                                ...
                                                <canvas id="year" class="full-width" width="1176"
